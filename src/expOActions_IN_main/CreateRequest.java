...
import expOActions_IN.Step01_CreateRequestIN;
...
public class CreateRequest
{
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step01_CreateRequestIN login = new Step01_CreateRequestIN(driver);
		login.login();
	}
	@Test(priority=1)
	public void Create_Req() 
	{
		...
		Step01_CreateRequestIN createreq = new Step01_CreateRequestIN(driver);
	...
	public void skill_Req() 
	{
		...
		Step01_CreateRequestIN skillreq = new Step01_CreateRequestIN(driver);
	...
	public void select_Req() 
	{
		...
		Step01_CreateRequestIN selectreq = new Step01_CreateRequestIN(driver);
	...
	public void req_detail() 
	{
		...
		Step01_CreateRequestIN reqdetail = new Step01_CreateRequestIN(driver);
	...
	public void skill_loc() 
	{
		...
		Step01_CreateRequestIN skillloc = new Step01_CreateRequestIN(driver);
	...
	public void alert_check() 
	{
		...
		Step01_CreateRequestIN alertchk = new Step01_CreateRequestIN(driver);
	...
	public void skill_price() 
	{
		...
		Step01_CreateRequestIN skillprice = new Step01_CreateRequestIN(driver);
	...
	public void supp() throws InterruptedException 
	{
		...
		Step01_CreateRequestIN supplier = new Step01_CreateRequestIN(driver);
