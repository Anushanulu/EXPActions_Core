...
public class Step05_ExO_Auth_Reject_returnUK {
...
@FindBy (xpath = ".//*[@name='tblcolCandId']" ) private WebElement select_chkbox ;
...
public Step05_ExO_Auth_Reject_returnUK(WebDriver driver)
{
	this.driver=driver;
