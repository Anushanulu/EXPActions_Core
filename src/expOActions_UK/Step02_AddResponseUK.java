...
public class Step02_AddResponseUK
{
	...
	public Step02_AddResponseUK (WebDriver driver)
	{
		this.driver=driver;
	...
	public void login(){
		...
		if (ContinueButton.isDisplayed())
		{
			...
			//UsernameField.clear();
			UsernameField.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 7, 0));
			...
			PasswordField.clear();
			PasswordField.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 7, 1));
	...
	public void openRequest() throws InterruptedException
	{
		...
		System.out.println("searched and Opened the request "+Excel.getCellValue(xlsFilePath, "Request_creation", 2, 15));
