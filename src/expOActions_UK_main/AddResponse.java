...
import expOActions_UK.Step02_AddResponseUK;
...
public class AddResponse
{
	...
	public void add_response() throws IOException, InterruptedException
	{
		...
		Step02_AddResponseUK addresp = new Step02_AddResponseUK(driver); 
		addresp.login();
		addresp.openRequest();
		...
		addresp.FillRespdetails("fResp", "mResp" , "lResp", "Cuba" , "10", "10"); 
		//Cand3 : Contolled country
		//addresp.FillRespdetails("fResp" , "Armenia" , "lResp", "Armenia" , "10", "10");
		//Cand1 & 4 :Non-Embargoed and Non-Contolled
		//addresp.FillRespdetails("fResp" , "Canada" , "lResp", "Canada" , "10", "10");
