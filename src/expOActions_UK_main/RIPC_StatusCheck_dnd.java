...
import expOActions_US.Step06_RIPC_ResponseStatus_dnd;


import lib.Excel;


public class RIPC_StatusCheck_dnd
{
	    ...
	    public void setup()
		{
		 ...
		 // test to Login to the application as RIPC
		  ...
		  public void RIPC_Login() 
		  {
			  ...
			  Step06_RIPC_ResponseStatus_dnd statuschk = new  Step06_RIPC_ResponseStatus_dnd(driver);
			  statuschk.status();
