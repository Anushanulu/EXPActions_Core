...
public class Step02_AddResponseIN
{
	...
	public Step02_AddResponseIN (WebDriver driver)
	{
		this.driver=driver;
	...
	public void login(){
		...
		if (ContinueButton.isDisplayed())
		{
			...
			//UsernameField.clear();
			UsernameField.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 13, 0));
			...
			PasswordField.clear();
			PasswordField.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 13, 1));
	...
	//Add Response and details
	public void FillRespdetails(String First_Name_temp , String Middle_Name_temp , String LastName_Surname_temp, String citizenship , String rate, String wage, String Refernce_Num ) throws IOException, InterruptedException 
	{
