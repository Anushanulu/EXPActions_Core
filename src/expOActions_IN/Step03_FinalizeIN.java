...
public class Step03_FinalizeIN {
...
@FindBy (xpath= ".//*[@id='content-main']/table[2]/tbody/tr[8]/td[3]//textarea[@id='FLD_DETAIL_JOB_SCOPE']") private WebElement job_Scope_Cand1;
...
@FindBy (xpath= ".//*[@id='content-main']/table[2]/tbody/tr[10]/td[3]//textarea[@id='FLD_DESC_SOFTWARE_TECH']") private WebElement softTech_Access_Cand1;
...
@FindBy (xpath=".//*[@id='content-main']/table[2]/tbody/tr[5]/td[3]/input") private WebElement Reporting_Manager_btn_Cand1;
...
public Step03_FinalizeIN(WebDriver driver)
{
	this.driver=driver;
...
//	Sensitive_Material_Cand4_Y.click();
	...
	Step03_FinalizeIN popup = new Step03_FinalizeIN(driver);
