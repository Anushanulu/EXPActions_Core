...
public class Step05_ExO_Auth_Reject_returnUS {
...
//@FindBy (xpath = ".//*[@id='content-main']/form/table[3]/tbody/tr[2]/td[4]/a" ) private WebElement Resp_identification1 ;
//@FindBy (xpath = ".//*[@id='content-main']/form/table[3]/tbody/tr[3]/td[4]/a" ) private WebElement Resp_identification2 ;
//@FindBy (xpath = ".//*[@id='content-main']/form/table[3]/tbody/tr[4]/td[4]/a" ) private WebElement Resp_identification3 ;
//@FindBy (xpath = ".//*[@id='content-main']/form/table[3]/tbody/tr[5]/td[4]/a" ) private WebElement Resp_identification4 ;
...
public Step05_ExO_Auth_Reject_returnUS(WebDriver driver)
{
	this.driver=driver;
...
//	loginToContractor_Link.click();
	...
	login_username.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 32, 0));
	Thread.sleep(1000);
	login_password.clear();
	login_password.sendKeys(Excel.getCellValue(xlsFilePath, sheet, 32, 1));
	...
	try {
		...
		//Totp_Link.click();
		String otpKeyStr = "EJCZOHELPDP5HLFM";// bennett05@c25a0161.toronto.ca.ibm.com
...
public void EO_Return_req ()
{
	...
	//wait07.until(ExpectedConditions.visibilityOf(Resp_identification));
